...
contract MultiLegacyVaultUpgradeable is
    Initializable,
    OwnableUpgradeable,
    UUPSUpgradeable,
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(address _oracleSigner) public initializer {
        __Ownable_init(msg.sender); // OZ v5-compatible initializer
    ...
    function triggerInheritance(address user) external nonReentrant {
        ...
        require(
            block.timestamp > v.lastHeartbeat + v.inactivityPeriod,
            "Still active"
        );
